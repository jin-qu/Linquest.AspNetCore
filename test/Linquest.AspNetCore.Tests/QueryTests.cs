...
public class QueryTests {
    ...
    public async Task ShouldGetPageData() {
        ...
        const string url1 = "api/Test/Orders?$inlineCount=allpages&$skip=2&$take=2";
        ...
        const string url2 = "api/Test/Orders?$inlineCount=false&$skip=2&$take=2";
        ...
        Assert.False(dynContent2.TryGetValue("inlineCount", StringComparison.CurrentCulture, out _));

        const string url3 = "api/Test/Orders?$inlineCount&$take=2";
    ...
    private static readonly int[] _expected = [1, 1, 2, 1];
    ...
    public void ShouldCheckArguments() {
        ...
        var orders = Constants.Orders.AsQueryable();
